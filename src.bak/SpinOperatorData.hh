...
SpinOperator_<4> signed_permutation_flipper_4({OP(-s[0],s[1],s[2],s[3]), OP(-s[1],-s[0],s[2],s[3]),
...
SpinOperator_<2> cos6_flipper({OP(-s[0],s[1]), OP(-0.5*s[0]-q*s[1],-q*s[0]+0.5*s[1]),
OP(-0.5*s[0]+q*s[1],q*s[0]+0.5*s[1]),
OP(0.5*s[0]-q*s[1],-q*s[0]-0.5*s[1]),
OP(0.5*s[0]+q*s[1],q*s[0]-0.5*s[1]), OP(s[0],-s[1])});
...
OP(r*s[2]+r*s[3],-r*s[2]+r*s[3],r*s[0]-r*s[1],r*s[0]+r*s[1],r*s[4]-r*s[5],-r*s[4]-r*s[5]),
OP(r*s[2]+r*s[3],r*s[2]-r*s[3],r*s[0]+r*s[1],r*s[0]-r*s[1],-r*s[4]-r*s[5],-r*s[4]+r*s[5]),
OP(r*s[2]+r*s[3],r*s[2]-r*s[3],r*s[0]+r*s[1],r*s[0]-r*s[1],r*s[4]+r*s[5],r*s[4]-r*s[5]), OP(s[1],s[0],-s[2],s[3],s[4],s[5]),
OP(s[1],s[0],s[2],-s[3],s[4],s[5]),
OP(s[0],-s[1],s[2],s[3],-s[5],-s[4]),
OP(s[0],-s[1],s[2],s[3],s[5],s[4]),
OP(s[0],s[1],-s[2],-s[3],s[4],s[5]),
